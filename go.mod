...
require (
	...
	github.com/PlakarKorp/integration-fs v1.0.7
	github.com/PlakarKorp/integration-grpc v1.0.13
	github.com/PlakarKorp/integration-ptar v1.0.1
	github.com/PlakarKorp/integration-stdio v1.0.1
